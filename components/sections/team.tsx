export function Team() {
  return (
    <section id="team" className="relative bg-black/[0.02] py-24 md:py-32">
      <div
        ...
        <div className="grid gap-16 md:grid-cols-2 md:gap-20">
          <div className="grid grid-cols-2 gap-6">
            {[1, 2, 3, 4].map((i) => (
              <div
                key={i}
                className="aspect-square rounded-2xl bg-gradient-to-br from-black/5 to-black/10 transition-all duration-300 hover:scale-105"
              />
            ))}
          </div>
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="mt-8 space-y-6 text-xl leading-relaxed text-black/70">
              <p className="transition-all hover:text-black/90">
